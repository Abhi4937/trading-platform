...
export const historicalApi = {
  ...
  async getChartDataWithGreeks(expiry: string, strike: number, type: 'CE' | 'PE', startTime: number, timeframe: string, rvWindowDays: number = 30, signal?: AbortSignal): Promise<ChartDataWithGreeksResponse> {
