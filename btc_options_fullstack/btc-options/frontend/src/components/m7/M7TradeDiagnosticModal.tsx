...
const KV_INFO: Record<string, string> = {
  ...
  'max mtm': 'Peak unrealized P&L during the hold (entry slippage only — what you would have seen on screen at the best moment).',
  'min mtm': 'Trough unrealized P&L during the hold (entry slippage only — worst moment on screen).',
  'exit mtm': 'On-screen P&L at the moment of exit (gross − entry slippage only). NOT the realised number (exit costs not yet deducted).',
